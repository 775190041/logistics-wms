            ...
            parent.$.modalDialog({
                ...
                buttons : [ {
                    ...
                    handler : function() {
                        ...
                        var f = parent.$.modalDialog.handler.find('#carogAddForm');
                        f.submit();
                    }
                } ]
            });
...
<div id="toolbar" style="display: none;padding:5px;">
    <shiro:hasPermission name="/cargo/insert">
        ...
        <a onclick=" " href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-folder'">打印盘点货物单</a>
        <a onclick=" " href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-folder'">打印货物出库单</a>
    </shiro:hasPermission>
</div>
</body>
</html>
