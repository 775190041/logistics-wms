...
<head>
    ...
    <script type="text/javascript">
        ...
        function editFun(id) {
            ...
            var miNum = row.miNum;
            var name = $("#name").val();
            var miSkumodel  = row.miSkumodel;

            parent.$.messager.confirm('询问', '您是否要更新当前数据？', function(flog){
                if(flog){
                    $.post('${path }/make/edit', {
                        id : id,
                        miActual : miActual,
