    ...
    $(function() {
        ...
        $("#selectCombobox").combobox({
            ...
            onLoadSuccess:function () {
                ...
                if(data.length > 0){
                    //选择指定项
                    $('#selectCombobox').combobox('select','${cargo.cWhid}');
                }
            }
        })
        ...
        <form id="CargoEditForm" method="post">
            <table class="grid">
                ...
                <tr>
                    ...
                    <td>货主号码</td>
                    <td><input name="cPhone" type="text" class="easyui-validatebox" data-options="required:true,novalidate:true" value="${cargo.cPhone}"></td>
                </tr>
                <tr>
                    <td><input name="cId" type="hidden" value="${cargo.cId}">
                </tr>
            </table>
        </form>
    </div>
