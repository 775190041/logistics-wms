...
<title>收货单管理</title>
    ...
    function cleanFun() {
        $('.boxValue').val('');
        $('.selectValue').combobox('setValue'," ");
        $('.optionValue').combobox('setValue'," ");
    ...
    <div data-options="region:'north',border:true" style="height: 70px; overflow: hidden;background-color: #fff">
        <form id="searchForm">
            <table>
                <tr>
                    <th>货物名称:</th>
                    <td><input  class="boxValue" name="rName" placeholder="请输入货物名称"/></td>
                    <th>货物型号:</th>
                    <td><input   class="boxValue" name="rSkumodel" placeholder="请输入货物型号"/></td>
                    <th>入库时间:</th>
                    <td>
	                    <input  class="boxValue" name="createdateStart" placeholder="点击选择时间" onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})" readonly="readonly" />至<input id="a"  name="createdateEnd" placeholder="点击选择时间" onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})" readonly="readonly" />
                    </td>
                </tr>
                 <tr>
                    <th>供应商:</th>
                    <td><input class="boxValue" name="rSupplierid" placeholder="请输入供应商名称"/></td>
                    <th>是否越库:</th>
                    <td>
                    	<select   name="rCrossflag" class="easyui-combobox  selectValue" data-options="width:80,height:24,editable:false,panelHeight:'auto'">
                    ...
                    <th>是否整进:</th>
                    <td>
                    	<select  name="rDirectflag" class="easyui-combobox optionValue" data-options="width:80,height:24,editable:false,panelHeight:'auto'">
                    		<option value=" " selected="selected">请选择</option>
