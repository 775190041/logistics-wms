        ...
        <form id="allotputEditForm" method="post">
            <table class="grid">
                ...
                <tr>
                    <td>调拨时间</td>
                    <td>
                        <input name="time" style="width:100%" placeholder="点击选择时间" onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd '})"  value="<fmt:formatDate pattern="yyyy-MM-dd " value="${allotput.apTime}" />" readonly="readonly" />
                </tr>
            </table>
        </form>
    </div>
