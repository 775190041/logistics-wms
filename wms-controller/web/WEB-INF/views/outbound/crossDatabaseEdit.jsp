        ...
        <form id="crossDatabaseEditForm" method="post">
            <table class="grid">
                ...
                <tr>
                    ...
                    <td>发货重量</td>
                    <td><input name="cdTotalweigh" type="text" placeholder="请输入发货重量" class="easyui-validatebox" data-options="required:true,validType:'length[1,20]',novalidate:true" value="${crossDatabase.cdTotalweigh}"></td>
                </tr>
                <tr>
                    <td>货主</td>
                    <td><input name="cdStore" type="text" placeholder="请输入货主" class="easyui-validatebox" data-options="required:true,validType:'length[1,20]',novalidate:true" value="${crossDatabase.cdStore}"></td>
                    <td>货主号码</td>
                    <td><input name="cdPhone" type="text" placeholder="请输入货主号码" class="easyui-validatebox" data-options="required:true,validType:'length[1,20]',novalidate:true" value="${crossDatabase.cdPhone}"></td>
                </tr>
                <tr>
                	<td>损坏数量</td>
                    <td><input name="cdDamage" type="text" placeholder="请输入损坏数量" value="0"></td>
                </tr>
                <tr>
                	<td>损坏原因</td>
                    <td colspan="3"><textarea rows="3" cols="40" name="cdCause" style="width: 397px;height: 50px;" placeholder="请输入损坏原因"> </textarea></td>
                </tr>
            </table>
        </form>
    </div>
