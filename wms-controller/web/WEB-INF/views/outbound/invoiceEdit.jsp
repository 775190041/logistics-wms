    ...
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
        <form id="invoiceEditForm" method="post">
            <table class="grid">
                ...
                <tr>
                    <td>货主</td>
                    <td><input name="inStore" type="text" placeholder="请输入货主姓名" class="easyui-validatebox" data-options="required:true,validType:'length[1,20]',novalidate:true" value="${invoice.inStore}"></td>
                    <td>货主号码</td>
                    <td><input name="inPhone" type="text" placeholder="请输入货主号码" class="easyui-validatebox" data-options="required:true,validType:'length[1,13]',novalidate:true" value="${invoice.inPhone}"></td>
                </tr>
                <tr>
                    <td>发货数量</td>
                ...
                <tr>
                    ...
                    <td>货物毛重</td>
                    <td><input name="inTotalweigh" type="text" placeholder="请输入货物毛重" class="easyui-validatebox" data-options="required:true,validType:'length[1,20]',novalidate:true" value="${invoice.inTotalweigh}"></td>
                </tr>
            </table>
        </form>
    </div>
