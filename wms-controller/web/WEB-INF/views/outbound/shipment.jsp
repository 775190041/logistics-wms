...
<script>
                ...
                formatter: function (value, row, index) {
                    ...
                    <shiro:hasPermission name="/shipment/update">
                    	if(row.status == 0){
                   			...
                   			str += $.formatString('<a style="height: 24px;" href="javascript:void(0)" class="user-easyui-linkbutton-edit1" data-options="plain:true,iconCls:\'icon-edit\'" onclick=" " >付款</a>', row.shId);
    ...
    function ok(i){
    	...
    	if(i == 1){
    		var id = $("#shids").val();
        	var reason = $("#yuanying").textbox('getValue');
        	window.location.href = '${path }/shipment/toexcel?id='+id+'&reason='+reason;
        	$("#addWin").window("close");
        	b =1;
    	}else{
    		b = 0;
